...
for session in session_list:
    ...
    for seed in seed_list:
        natural_prediction=np.load(f"/home/helenr6/V4_mapping/{session}/{model}_{seed}_natural_prediction.npy",allow_pickle=True)
        synth_prediction=np.load(f"/home/helenr6/V4_mapping/{session}/{model}_{seed}_synth_prediction.npy",allow_pickle=True)
        if cc==0:
            ...
            cc=cc+1
    np.save(f'/home/helenr6/V4_mapping/{session}/{model}_synth_neuron_corr.npy',total_synth_corr)
    np.save(f'/home/helenr6/V4_mapping/{session}/{model}_natural_neuron_corr.npy',total_natural_corr)