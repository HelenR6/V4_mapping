...
parser.add_argument('--input_path', default='/content/gdrive/MyDrive', type=str,
                    help='session')
parser.add_argument('--jitter', default='features', type=str,
                    help='session')
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.jitter=="features" or args.jitter=="both" :
    ...
    if args.jitter=="mapper" or args.jitter=="both" :
    ...
    ood_val_dataset = CustomImageDataset(args.session,preprocess,'val_ood',args.input_path,args.index,args.method,args.severity)
    ...
    id_val_dataset = CustomImageDataset(args.session,preprocess,'val_id',args.input_path,args.index,args.method,args.severity)
    ...
    #         normalize,
    #     ]))
    train_dataset = CustomImageDataset(args.session,preprocess,'train',args.input_path,args.index,args.method,args.severity)
    ...
    if args.adjusted:
        ...
        file_name=f"jitter_{args.jitter}_adjusted_50_{args.arch}_wd={args.weight_decay}_bs={args.batch_size}_epoch={args.epochs}_lr={args.lr}"
    else:
        # if args.shuffle:
        file_name=f"jitter_{args.jitter}_standard_{args.arch}_wd={args.weight_decay}_bs={args.batch_size}_epoch={args.epochs}_lr={args.lr}"
        # else:
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if epoch==99:
            ...
            if os.path.isfile(f'/home/helenr6/V4_mapping/{args.session}/temp_{args.jitter}_{args.arch}_{args.seed}_synth_prediction.npy'):
                _array=np.load(f'/home/helenr6/V4_mapping/{args.session}/temp_{args.jitter}_{args.arch}_{args.seed}_synth_prediction.npy',allow_pickle=True)
                _array[args.index]=ood_np.cpu().data.numpy()
                np.save(f'/home/helenr6/V4_mapping/{args.session}/temp_{args.jitter}_{args.arch}_{args.seed}_synth_prediction.npy',_array)
            else:
                _array=np.empty((5,ood_shape[0],ood_shape[1]), dtype=object)
                _array[args.index]=ood_np.cpu().data.numpy()
                np.save(f'/home/helenr6/V4_mapping/{args.session}/temp_{args.jitter}_{args.arch}_{args.seed}_synth_prediction.npy',_array)

            if os.path.isfile(f'/home/helenr6/V4_mapping/{args.session}/{args.jitter}_{args.arch}_{args.seed}_natural_prediction.npy'):
                _array=np.load(f'/home/helenr6/V4_mapping/{args.session}/{args.jitter}_{args.arch}_{args.seed}_natural_prediction.npy',allow_pickle=True)
                _array[id_indices]=id_np.cpu().data.numpy()
                np.save(f'/home/helenr6/V4_mapping/{args.session}/{args.jitter}_{args.arch}_{args.seed}_natural_prediction.npy',_array)
            else:
    ...
    if args.index==4:
        ...
        np.save(f'/home/helenr6/V4_mapping/{args.session}/{args.jitter}_{args.arch}_{args.seed}_synth_prediction.npy',sum_array)
